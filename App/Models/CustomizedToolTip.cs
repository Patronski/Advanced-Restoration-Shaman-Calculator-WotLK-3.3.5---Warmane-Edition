...
namespace CustomToolTipDemo
{
    ...
    internal class CustomizedToolTip : ToolTip
    {
        ...
        private static Color myBorderColor = Color.Blue;
        ...
        private void CustomizedToolTip_Draw(object sender, DrawToolTipEventArgs e)
        {
            try
            {
                ...
                {
                    myImageRectangle.Width = (int)toolTipImage.PhysicalDimension.Width; //myInternalImageWidth
                    myImageRectangle.Height = (int)toolTipImage.PhysicalDimension.Height;
